...
/*   Updated: 2023/11/23 18:39:48 by gsmereka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define AMBIENT_RATIO_ERROR "Error\nThe 'A' (Ambient Lighting) lighting_ratio parameter should be \
in range [0:1]\n"
...
in the following format: 'L COORDINATE 3D_NORMALIZED_VECTOR LIGHTING_RATIO \
COLOR(BONUS ONLY)'.\n"
# define LIGHT_COORDINATE_ERROR "Error\nThe 'L' (Light) coordinate parameter should be \
in the following format: '0.0,0.0,0.0'.\n"
# define LIGHT_LIGHTING_RATIO_ERROR "Error\nThe 'L' (Light) lighting_ratio \
